...
public class Kayoko extends Item {
    ...
    private void randomlyEnhancePlayerItem(Player player, Random rand) {
        ...
        // 检查物品是否已有附魔
        boolean hasEnchantments = !getEnchantments(targetStack).isEmpty();
        ...
        while (attempts < maxAttempts) {
            ...
            if (enchantment.canEnchant(stack)) {
                ...
                if (currentEnchantments.containsKey(enchantment)) {
                    ...
                    setEnchantments(currentEnchantments, stack);
                } else {
                    // 检查与其他附魔的兼容性
    ...
    public static void triggerTotemEffect(Player player) throws IOException {
